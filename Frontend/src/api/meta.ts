...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  tag = {
    ...
    getTag: (params: RequestParams = {}) =>
      this.request<AssetTagStateDto, any>({
        path: `/Tag`,
        method: "GET",
        format: "json",
        ...params,
     ...
     */
    postTag: (query?: { asset?: string | null; tag?: string | null }, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/Tag/add`,
        method: "POST",
        query: query,
     ...
     * @tags Tag
     * @name RemoveCreate
     * @request POST:/Tag/remove
     */
    removeCreate: (query?: { asset?: string | null; tag?: string | null }, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/Tag/remove`,
        method: "POST",
        query: query,
